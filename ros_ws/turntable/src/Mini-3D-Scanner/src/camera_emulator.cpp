...
//TODO - change all literal folder names to ros_param in launch file
int
main (int argc, char **argv)
{
    ...
    ros::init (argc, argv, "camera_emu_scanner");

    ros::NodeHandle nh;
    ros::Publisher emu_pub = nh.advertise<sensor_msgs::PointCloud2> ("/camera/depth_registered/points", 1);

    sensor_msgs::PointCloud2 output;
    pcl::PointCloud<PointT>::Ptr cloud_ptr (new pcl::PointCloud<PointT>);

    std::string dir = "/home/shabelson/Documents/studio_exps/exp1/raw/";
    ...
    while (ros::ok())
    {
        ...
        ROS_INFO("LOADED FILFE %i",cloud_ptr->points.size ());
