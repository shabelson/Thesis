...
if("TRUE" STREQUAL "TRUE")
  set(descartes_core_SOURCE_PREFIX /home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/src/descartes/descartes_core)
  set(descartes_core_DEVEL_PREFIX /home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/devel/.private/descartes_core)
  ...
  set(descartes_core_INSTALL_PREFIX /home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/install)
...
if(NOT "/home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/src/descartes/descartes_core/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(descartes_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/src/descartes/descartes_core/include;/usr/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'descartes_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/src/descartes/descartes_core/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT descartes_core_NUM_DUMMY_TARGETS)
      set(descartes_core_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::descartes_core::wrapped-linker-option${descartes_core_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR descartes_core_NUM_DUMMY_TARGETS "${descartes_core_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::descartes_core::wrapped-linker-option${descartes_core_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND descartes_core_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/devel/.private/descartes_core/lib;/home/shabelson/Documents/GitHub/Thesis/ros_ws/st4_ws/devel/lib;/opt/ros/melodic/lib)
