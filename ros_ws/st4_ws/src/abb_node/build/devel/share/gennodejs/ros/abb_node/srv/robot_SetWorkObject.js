...
class robot_SetWorkObjectRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_SetWorkObjectRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_SetWorkObjectRequest
    let len;
    let data = new robot_SetWorkObjectRequest(null);
  ...
  static datatype() {
    ...
    return 'abb_node/robot_SetWorkObjectRequest';
  }
...
>>>>>>> 1b1f87b6247333221ca1660d810eda01b82fd03f
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_SetWorkObjectRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class robot_SetWorkObjectResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.ret = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_SetWorkObjectResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_SetWorkObjectResponse
    let len;
    let data = new robot_SetWorkObjectResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'abb_node/robot_SetWorkObjectResponse';
  }
...
>>>>>>> 1b1f87b6247333221ca1660d810eda01b82fd03f
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_SetWorkObjectResponse(null);
...
module.exports = {
  Request: robot_SetWorkObjectRequest,
  Response: robot_SetWorkObjectResponse,
  md5sum() { return '13716a3f1e232bc5200a276031ef97c2'; },
  datatype() { return 'abb_node/robot_SetWorkObject'; }
};
